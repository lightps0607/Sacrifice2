...
namespace Photon.Pun.UtilityScripts
{
    ...
    /// </remarks>
    public class CTimer : MonoBehaviourPunCallbacks
    {
        /// <summary>
        ...
        public void Update()
        {
            ...
            this.Text.text = string.Format("{0:0}:{1:00}", minutes, seconds);
        ...
        public static void SetStartTime()
        {
            ...
            {
                { CTimer.CountdownStartTime, (int)PhotonNetwork.ServerTimestamp}
            };
